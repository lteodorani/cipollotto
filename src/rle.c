...
bool cstack_init(cstack* cs, size_t n){
...
bool cstack_push(cstack* cs, size_t v){
...
bool cstack_pop(cstack* cs, size_t* d){

    // err if cs, d or cs initialized, err also if stack is empty
